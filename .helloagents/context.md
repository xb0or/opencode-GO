...
GO ???????????? UI ???GO ????????????? group ?? `go`?`/admin/keys/:id/quota` ???? Go quota bucket?rolling/weekly/monthly ? `usagePercent`?`resetInSec`??????? `usage` ???total?rolling=?1???weekly=?7??monthly=?30????? requests/inputTokens/outputTokens/totalTokens?????? `checkedAt + resetInSec` ????????????

KEY ???`pool.Picker.MarkFailureWithQuota` ?? 429??????? quota snapshot ?? weekly/monthly ? usagePercent=100 ???????????????? rolling resetInSec??????? 429 ?????????

?????`/admin/tokens` ???????? `total_requests`?`total_tokens`?`today_requests`?`today_tokens`?`last_hour_requests`?`last_hour_tokens` ???? Token ????????/??/?1?????

???????`UPSTREAM_TIMEOUT=0` ???????????????????????????????????? `context.WithTimeout`?????????????????????? 120 ??????????????? `context canceled` ?????????499??? `context deadline exceeded` ??/????????504????? 502 ? KEY ?????
